...
It relies on Postgres as well.
You will need to gem install rails first.
...
Future Features:
Move add comment form onto posts#show together with displayed comments. (removing comments#new)
